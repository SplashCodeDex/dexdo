...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,description,isCompleted,completionDate,isStarred,icon,color,category,attachmentCount,const DeepCollectionEquality().hash(subtasks),dueDate,orderIndex,recurrence,priority,isDeleted,updatedAt);

@override
String toString() {
  return 'Task(id: $id, title: $title, description: $description, isCompleted: $isCompleted, completionDate: $completionDate, isStarred: $isStarred, icon: $icon, color: $color, category: $category, attachmentCount: $attachmentCount, subtasks: $subtasks, dueDate: $dueDate, orderIndex: $orderIndex, recurrence: $recurrence, priority: $priority, isDeleted: $isDeleted, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String id, String title, String description, bool isCompleted, DateTime? completionDate, bool isStarred,@IconDataConverter() IconData icon,@ColorConverter() Color color, String category, int attachmentCount, List<SubTask> subtasks, DateTime? dueDate, int orderIndex, String recurrence, TaskPriority priority, bool isDeleted, DateTime? updatedAt
});
...
/// Create a copy of Task
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? title = null,Object? description = null,Object? isCompleted = null,Object? completionDate = freezed,Object? isStarred = null,Object? icon = null,Object? color = null,Object? category = null,Object? attachmentCount = null,Object? subtasks = null,Object? dueDate = freezed,Object? orderIndex = null,Object? recurrence = null,Object? priority = null,Object? isDeleted = null,Object? updatedAt = freezed,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,title: null == title ? _self.title : title // ignore: cast_nullable_to_non_nullable
...
as TaskPriority,isDeleted: null == isDeleted ? _self.isDeleted : isDeleted // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _Task() when $default != null:
return $default(_that.id,_that.title,_that.description,_that.isCompleted,_that.completionDate,_that.isStarred,_that.icon,_that.color,_that.category,_that.attachmentCount,_that.subtasks,_that.dueDate,_that.orderIndex,_that.recurrence,_that.priority,_that.isDeleted,_that.updatedAt);case _:
  return orElse();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,description,isCompleted,completionDate,isStarred,icon,color,category,attachmentCount,const DeepCollectionEquality().hash(_subtasks),dueDate,orderIndex,recurrence,priority,isDeleted,updatedAt);
